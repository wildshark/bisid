...
$membership_add = NULL; // Initialize page object first

class cmembership_add extends cmembership {
	...
	// Page object name
	var $PageObjName = 'membership_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "membershipview.php")
	...
	function LoadDefaultValues() {
		...
		$this->f_name->CurrentValue = NULL;
		$this->f_name->OldValue = $this->f_name->CurrentValue;
		...
		$this->level_edu->CurrentValue = NULL;
		$this->level_edu->OldValue = $this->level_edu->CurrentValue;
		$this->mentor->CurrentValue = NULL;
		$this->mentor->OldValue = $this->mentor->CurrentValue;
		$this->interest->CurrentValue = NULL;
		$this->interest->OldValue = $this->interest->CurrentValue;
		$this->affiliation->CurrentValue = NULL;
		$this->affiliation->OldValue = $this->affiliation->CurrentValue;
		$this->church->CurrentValue = NULL;
		$this->church->OldValue = $this->church->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['memberID'] = $this->memberID->CurrentValue;
		$row['f_name'] = $this->f_name->CurrentValue;
		...
		$row['level_edu'] = $this->level_edu->CurrentValue;
		$row['mentor'] = $this->mentor->CurrentValue;
		$row['interest'] = $this->interest->CurrentValue;
		$row['affiliation'] = $this->affiliation->CurrentValue;
		$row['church'] = $this->church->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// f_name
		$this->f_name->SetDbValueDef($rsnew, $this->f_name->CurrentValue, NULL, FALSE);

		// dob
		$this->dob->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->dob->CurrentValue, 0), NULL, FALSE);
		...
		// level_edu
		$this->level_edu->SetDbValueDef($rsnew, $this->level_edu->CurrentValue, NULL, FALSE);

		// mentor
		$this->mentor->SetDbValueDef($rsnew, $this->mentor->CurrentValue, NULL, FALSE);

		// interest
		$this->interest->SetDbValueDef($rsnew, $this->interest->CurrentValue, NULL, FALSE);

		// affiliation
		$this->affiliation->SetDbValueDef($rsnew, $this->affiliation->CurrentValue, NULL, FALSE);

		// church
		$this->church->SetDbValueDef($rsnew, $this->church->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($membership_add)) $membership_add = new cmembership_add();

// Page init
$membership_add->Page_Init();

// Page main
$membership_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$membership_add->Page_Render();
?>
...
var CurrentForm = fmembershipadd = new ew_Form("fmembershipadd", "add");

// Validate form
fmembershipadd.Validate = function() {
...
fmembershipadd.Form_CustomValidate = 
...
fmembershipadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $membership_add->ShowPageHeader(); ?>
<?php
$membership_add->ShowMessage();
?>
<form name="fmembershipadd" id="fmembershipadd" class="<?php echo $membership_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($membership_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $membership_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="membership">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($membership_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($membership->f_name->Visible) { // f_name ?>
	<div id="r_f_name" class="form-group">
		<label id="elh_membership_f_name" for="x_f_name" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->f_name->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->f_name->CellAttributes() ?>>
...
<?php if ($membership->dob->Visible) { // dob ?>
	<div id="r_dob" class="form-group">
		<label id="elh_membership_dob" for="x_dob" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->dob->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->dob->CellAttributes() ?>>
...
<?php if ($membership->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_membership_address" for="x_address" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->address->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->address->CellAttributes() ?>>
...
<?php if ($membership->nationality->Visible) { // nationality ?>
	<div id="r_nationality" class="form-group">
		<label id="elh_membership_nationality" for="x_nationality" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->nationality->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->nationality->CellAttributes() ?>>
...
<?php if ($membership->mobile->Visible) { // mobile ?>
	<div id="r_mobile" class="form-group">
		<label id="elh_membership_mobile" for="x_mobile" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->mobile->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->mobile->CellAttributes() ?>>
...
<?php if ($membership->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_membership__email" for="x__email" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->_email->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->_email->CellAttributes() ?>>
...
<?php if ($membership->occupation->Visible) { // occupation ?>
	<div id="r_occupation" class="form-group">
		<label id="elh_membership_occupation" for="x_occupation" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->occupation->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->occupation->CellAttributes() ?>>
...
<?php if ($membership->level_edu->Visible) { // level_edu ?>
	<div id="r_level_edu" class="form-group">
		<label id="elh_membership_level_edu" for="x_level_edu" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->level_edu->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->level_edu->CellAttributes() ?>>
...
<?php if ($membership->mentor->Visible) { // mentor ?>
	<div id="r_mentor" class="form-group">
		<label id="elh_membership_mentor" for="x_mentor" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->mentor->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->mentor->CellAttributes() ?>>
...
<?php if ($membership->interest->Visible) { // interest ?>
	<div id="r_interest" class="form-group">
		<label id="elh_membership_interest" for="x_interest" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->interest->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->interest->CellAttributes() ?>>
...
<?php if ($membership->affiliation->Visible) { // affiliation ?>
	<div id="r_affiliation" class="form-group">
		<label id="elh_membership_affiliation" for="x_affiliation" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->affiliation->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->affiliation->CellAttributes() ?>>
...
<?php if ($membership->church->Visible) { // church ?>
	<div id="r_church" class="form-group">
		<label id="elh_membership_church" for="x_church" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->church->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->church->CellAttributes() ?>>
...
<?php if ($membership->role->Visible) { // role ?>
	<div id="r_role" class="form-group">
		<label id="elh_membership_role" for="x_role" class="<?php echo $membership_add->LeftColumnClass ?>"><?php echo $membership->role->FldCaption() ?></label>
		<div class="<?php echo $membership_add->RightColumnClass ?>"><div<?php echo $membership->role->CellAttributes() ?>>
...
<?php if (!$membership_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $membership_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $membership_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
