...
if (!function_exists('DbHelper')) {
	...
	function &DbHelper($dbid = "", $langfolder = "", $langid = "", $info = NULL) {
		...
		$dbclass = "ciquipe_bisid_db";
		$dbhelper = new $dbclass($langfolder, $langid, $info);
		return $dbhelper;
	}
}

class ciquipe_bisid_db extends cDbHelper {

	// Database connection info
	var $Host = 'iquipe.heliohost.org';
	var $Port = 3306;
	var $Username = 'iquipe_bisid';
	var $Password = '@Bisid2018';
	var $DbName = 'iquipe_bisid';
	var $CharSet = "utf-8";
