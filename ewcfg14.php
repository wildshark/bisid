...
define("EW_PROJECT_ID", "{C94A36D7-4F8C-407F-9ED7-192C6149F989}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'qP26IG5GVvpZVIu5', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "iquipe.heliohost.org", "port" => 3306, "user" => "iquipe_bisid", "pass" => "@Bisid2018", "db" => "iquipe_bisid", "qs" => "`", "qe" => "`");
